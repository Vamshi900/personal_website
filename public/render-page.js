...
var _react = _interopRequireDefault(__webpack_require__(6806));
...
var React = _interopRequireWildcard(__webpack_require__(6806));
...
var _react = __webpack_require__(6806);
...
const preferDefault=m=>m&&m.default||m;exports.components={"component---cache-caches-gatsby-plugin-offline-app-shell-js":preferDefault(__webpack_require__(1930)),"component---src-pages-404-js":preferDefault(__webpack_require__(9616)),"component---src-pages-archive-js":preferDefault(__webpack_require__(226)),"component---src-pages-index-js":preferDefault(__webpack_require__(7704)),"component---src-pages-pensieve-index-js":preferDefault(__webpack_require__(3174)),"component---src-pages-pensieve-tags-js":preferDefault(__webpack_require__(2981)),"component---src-templates-post-js":preferDefault(__webpack_require__(9857)),"component---src-templates-tag-js":preferDefault(__webpack_require__(5847))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(9814),options:{"plugins":[]}},{name:'gatsby-plugin-styled-components',plugin:__webpack_require__(9310),options:{"plugins":[],"displayName":true,"fileName":true,"minify":true,"namespace":"","transpileTemplateLiterals":true,"topLevelImportPaths":[],"pure":false,"disableVendorPrefixes":false}},{name:'gatsby-plugin-image',plugin:__webpack_require__(573),options:{"plugins":[]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(6313),options:{"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(341),options:{"plugins":[],"name":"Vamshi Saggurthi","short_name":"Vamshi Saggurthi","start_url":"/","background_color":"#020c1b","theme_color":"#0a192f","display":"minimal-ui","icon":"src/images/logo.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"768188b28cc7a8a6a8ba206d2da5ed15"}},{name:'gatsby-plugin-offline',plugin:__webpack_require__(2100),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6806);
...
// EXTERNAL MODULE: external "/Users/vamshisaggurthi/Downloads/Devlopment/Personal website/personal_website/node_modules/react/index.js"
var index_js_ = __webpack_require__(6806);
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var React=_interopRequireWildcard(__webpack_require__(6806));var _gatsby=__webpack_require__(2031);var _common=__webpack_require__(8108);var _getManifestPathname=_interopRequireDefault(__webpack_require__(1632));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(6806));var _gatsby=__webpack_require__(2031);var _path=__webpack_require__(1423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var _react=_interopRequireDefault(__webpack_require__(6806));var _styledComponents=__webpack_require__(9550);var sheetByPathname=new Map();// eslint-disable-next-line react/prop-types,react/display-name
...
__webpack_require__.d(__webpack_exports__, {
  "JO": () => (/* reexport */ icon),
  "UN": () => (/* reexport */ appstore),
  "BZ": () => (/* reexport */ bookmark),
  "Pj": () => (/* reexport */ codepen),
  "Ak": () => (/* reexport */ external),
  "PU": () => (/* reexport */ folder),
  "Rt": () => (/* reexport */ fork),
  "Mr": () => (/* reexport */ github),
  "RM": () => (/* reexport */ instagram),
  "jb": () => (/* reexport */ linkedin),
  "pA": () => (/* reexport */ loader),
  "mp": () => (/* reexport */ logo),
  "cq": () => (/* reexport */ playstore),
  "GK": () => (/* reexport */ star),
  "JD": () => (/* reexport */ twitter)
});
...
const IconAppStore=()=>/*#__PURE__*/index_js_default().createElement("svg",{version:"1.1",xmlns:"http://www.w3.org/2000/svg",x:"0px",y:"0px",viewBox:"0 0 512 512",xmlSpace:"preserve"},/*#__PURE__*/index_js_default().createElement("title",null,"Apple App Store"),/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("path",{d:"M407,0H105C47.103,0,0,47.103,0,105v302c0,57.897,47.103,105,105,105h302c57.897,0,105-47.103,105-105V105 C512,47.103,464.897,0,407,0z M482,407c0,41.355-33.645,75-75,75H105c-41.355,0-75-33.645-75-75V105c0-41.355,33.645-75,75-75h302 c41.355,0,75,33.645,75,75V407z"}))),/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("path",{d:"M305.646,123.531c-1.729-6.45-5.865-11.842-11.648-15.18c-11.936-6.892-27.256-2.789-34.15,9.151L256,124.166 l-3.848-6.665c-6.893-11.937-22.212-16.042-34.15-9.151h-0.001c-11.938,6.893-16.042,22.212-9.15,34.151l18.281,31.664 L159.678,291H110.5c-13.785,0-25,11.215-25,25c0,13.785,11.215,25,25,25h189.86l-28.868-50h-54.079l85.735-148.498 C306.487,136.719,307.375,129.981,305.646,123.531z"}))),/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("path",{d:"M401.5,291h-49.178l-55.907-96.834l-28.867,50l86.804,150.348c3.339,5.784,8.729,9.921,15.181,11.65 c2.154,0.577,4.339,0.863,6.511,0.863c4.332,0,8.608-1.136,12.461-3.361c11.938-6.893,16.042-22.213,9.149-34.15L381.189,341 H401.5c13.785,0,25-11.215,25-25C426.5,302.215,415.285,291,401.5,291z"}))),/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("path",{d:"M119.264,361l-4.917,8.516c-6.892,11.938-2.787,27.258,9.151,34.15c3.927,2.267,8.219,3.345,12.458,3.344 c8.646,0,17.067-4.484,21.693-12.495L176.999,361H119.264z"}))));/* harmony default export */ const appstore = (IconAppStore);
;// CONCATENATED MODULE: ./src/components/icons/bookmark.js
const IconBookmark=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-bookmark"},/*#__PURE__*/index_js_default().createElement("title",null,"Bookmark"),/*#__PURE__*/index_js_default().createElement("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"}));/* harmony default export */ const bookmark = (IconBookmark);
;// CONCATENATED MODULE: ./src/components/icons/codepen.js
const IconCodepen=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-codepen"},/*#__PURE__*/index_js_default().createElement("title",null,"CodePen"),/*#__PURE__*/index_js_default().createElement("polygon",{points:"12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"}),/*#__PURE__*/index_js_default().createElement("line",{x1:"12",y1:"22",x2:"12",y2:"15.5"}),/*#__PURE__*/index_js_default().createElement("polyline",{points:"22 8.5 12 15.5 2 8.5"}),/*#__PURE__*/index_js_default().createElement("polyline",{points:"2 15.5 12 8.5 22 15.5"}),/*#__PURE__*/index_js_default().createElement("line",{x1:"12",y1:"2",x2:"12",y2:"8.5"}));/* harmony default export */ const codepen = (IconCodepen);
;// CONCATENATED MODULE: ./src/components/icons/external.js
const IconExternal=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-external-link"},/*#__PURE__*/index_js_default().createElement("title",null,"External Link"),/*#__PURE__*/index_js_default().createElement("path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}),/*#__PURE__*/index_js_default().createElement("polyline",{points:"15 3 21 3 21 9"}),/*#__PURE__*/index_js_default().createElement("line",{x1:"10",y1:"14",x2:"21",y2:"3"}));/* harmony default export */ const external = (IconExternal);
;// CONCATENATED MODULE: ./src/components/icons/folder.js
const IconFolder=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-folder"},/*#__PURE__*/index_js_default().createElement("title",null,"Folder"),/*#__PURE__*/index_js_default().createElement("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"}));/* harmony default export */ const folder = (IconFolder);
;// CONCATENATED MODULE: ./src/components/icons/fork.js
const IconFork=()=>/*#__PURE__*/index_js_default().createElement("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-git-branch"},/*#__PURE__*/index_js_default().createElement("title",null,"Git Fork"),/*#__PURE__*/index_js_default().createElement("line",{x1:"6",y1:"3",x2:"6",y2:"15"}),/*#__PURE__*/index_js_default().createElement("circle",{cx:"18",cy:"6",r:"3"}),/*#__PURE__*/index_js_default().createElement("circle",{cx:"6",cy:"18",r:"3"}),/*#__PURE__*/index_js_default().createElement("path",{d:"M18 9a9 9 0 0 1-9 9"}));/* harmony default export */ const fork = (IconFork);
// EXTERNAL MODULE: ./node_modules/prop-types/index.js
var prop_types = __webpack_require__(5697);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
;// CONCATENATED MODULE: ./src/components/icons/icon.js
const Icon=({name})=>{switch(name){case'AppStore':return/*#__PURE__*/index_js_default().createElement(appstore,null);case'Bookmark':return/*#__PURE__*/index_js_default().createElement(bookmark,null);case'Codepen':return/*#__PURE__*/index_js_default().createElement(codepen,null);case'External':return/*#__PURE__*/index_js_default().createElement(external,null);case'Folder':return/*#__PURE__*/index_js_default().createElement(folder,null);case'Fork':return/*#__PURE__*/index_js_default().createElement(fork,null);case'GitHub':return/*#__PURE__*/index_js_default().createElement(github,null);case'Instagram':return/*#__PURE__*/index_js_default().createElement(instagram,null);case'Linkedin':return/*#__PURE__*/index_js_default().createElement(linkedin,null);case'Loader':return/*#__PURE__*/index_js_default().createElement(loader,null);case'Logo':return/*#__PURE__*/index_js_default().createElement(logo,null);case'PlayStore':return/*#__PURE__*/index_js_default().createElement(playstore,null);case'Star':return/*#__PURE__*/index_js_default().createElement(star,null);case'Twitter':return/*#__PURE__*/index_js_default().createElement(twitter,null);default:return/*#__PURE__*/index_js_default().createElement(external,null);}};Icon.propTypes={name:(prop_types_default()).string.isRequired};/* harmony default export */ const icon = (Icon);
;// CONCATENATED MODULE: ./src/components/icons/github.js
const IconGitHub=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-github"},/*#__PURE__*/index_js_default().createElement("title",null,"GitHub"),/*#__PURE__*/index_js_default().createElement("path",{d:"M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"}));/* harmony default export */ const github = (IconGitHub);
;// CONCATENATED MODULE: ./src/components/icons/instagram.js
const IconInstagram=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-instagram"},/*#__PURE__*/index_js_default().createElement("title",null,"Instagram"),/*#__PURE__*/index_js_default().createElement("rect",{x:"2",y:"2",width:"20",height:"20",rx:"5",ry:"5"}),/*#__PURE__*/index_js_default().createElement("path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"}),/*#__PURE__*/index_js_default().createElement("line",{x1:"17.5",y1:"6.5",x2:"17.51",y2:"6.5"}));/* harmony default export */ const instagram = (IconInstagram);
;// CONCATENATED MODULE: ./src/components/icons/linkedin.js
const IconLinkedin=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-linkedin"},/*#__PURE__*/index_js_default().createElement("title",null,"LinkedIn"),/*#__PURE__*/index_js_default().createElement("path",{d:"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"}),/*#__PURE__*/index_js_default().createElement("rect",{x:"2",y:"9",width:"4",height:"12"}),/*#__PURE__*/index_js_default().createElement("circle",{cx:"4",cy:"4",r:"2"}));/* harmony default export */ const linkedin = (IconLinkedin);
;// CONCATENATED MODULE: ./src/components/icons/loader.js
const IconLoader=()=>/*#__PURE__*/index_js_default().createElement("svg",{id:"logo",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 100 100"},/*#__PURE__*/index_js_default().createElement("title",null,"Loader Logo"),/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("g",{id:"V",transform:"translate(-9.000000, -5.000000)"},/*#__PURE__*/index_js_default().createElement("path",{d:"M63.146790,58.083878  C64.119072,55.555401 64.690475,53.212135 65.912750,51.280773  C66.899712,49.721241 68.671593,48.658451 70.095276,47.375301  C70.661316,47.820415 71.227356,48.265530 71.793388,48.710640  C68.922081,55.837433 66.152122,63.010284 62.976284,69.998688  C62.736698,70.525894 58.396839,70.302704 58.011871,69.475182  C54.875565,62.733421 52.227421,55.764565 50.169132,48.436188  C58.715328,50.367886 56.567631,59.377850 60.797871,64.300110  C61.504063,62.445911 62.265572,60.446468 63.146790,58.083878  z",fill:"currentColor"})),/*#__PURE__*/index_js_default().createElement("path",{stroke:"currentColor",strokeWidth:"5",strokeLinecap:"round",strokeLinejoin:"round",d:"M 50, 5 L 11, 27 L 11, 72 L 50, 95 L 89, 73 L 89, 28 z"})));/* harmony default export */ const loader = (IconLoader);
;// CONCATENATED MODULE: ./src/components/icons/logo.js
const IconLogo=()=>/*#__PURE__*/index_js_default().createElement("svg",{id:"logo",xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 84 96"},/*#__PURE__*/index_js_default().createElement("title",null,"Logo"),/*#__PURE__*/index_js_default().createElement("g",{transform:"translate(-10.000000, 2.000000)"},/*#__PURE__*/index_js_default().createElement("g",{transform:"translate(-5.000000, -12.000000)"},/*#__PURE__*/index_js_default().createElement("path",{fill:"#010101",opacity:"1.000000",stroke:"none",d:"\nM69.000000,121.000000  C46.000000,121.000000 23.500000,121.000000 1.000000,121.000000  C1.000000,81.000000 1.000000,41.000000 1.000000,1.000000  C41.000000,1.000000 81.000000,1.000000 121.000000,1.000000  C121.000000,41.000000 121.000000,81.000000 121.000000,121.000000  C103.833336,121.000000 86.666664,121.000000 69.000000,121.000000 \nM55.282154,105.120041  C57.773529,106.405266 59.615246,109.265274 63.259087,107.105148  C75.239334,100.003067 87.414116,93.228798 99.380234,86.103683  C100.696960,85.319649 101.864296,83.094658 101.889404,81.518677  C102.101654,68.199409 101.960136,54.874874 102.104378,41.553864  C102.135376,38.691242 101.136131,37.137188 98.635811,35.742939  C86.745285,29.112474 75.010773,22.202126 63.114883,15.581572  C61.875477,14.891789 59.599720,14.851439 58.376137,15.533978  C46.474781,22.172798 34.652996,28.958904 22.937508,35.920086  C21.557783,36.739902 20.139284,38.850765 20.115438,40.384541  C19.898018,54.369892 19.926765,68.360641 20.079809,82.347664  C20.094475,83.687973 21.097120,85.594170 22.219824,86.256073  C32.937527,92.574791 43.780098,98.681725 55.282154,105.120041 \nz"}),/*#__PURE__*/index_js_default().createElement("path",{fill:"#E4E5E7",opacity:"1.000000",stroke:"none",d:"\nM54.934486,104.984756  C43.780098,98.681725 32.937527,92.574791 22.219824,86.256073  C21.097120,85.594170 20.094475,83.687973 20.079809,82.347664  C19.926765,68.360641 19.898018,54.369892 20.115438,40.384541  C20.139284,38.850765 21.557783,36.739902 22.937508,35.920086  C34.652996,28.958904 46.474781,22.172798 58.376137,15.533978  C59.599720,14.851439 61.875477,14.891789 63.114883,15.581572  C75.010773,22.202126 86.745285,29.112474 98.635811,35.742939  C101.136131,37.137188 102.135376,38.691242 102.104378,41.553864  C101.960136,54.874874 102.101654,68.199409 101.889404,81.518677  C101.864296,83.094658 100.696960,85.319649 99.380234,86.103683  C87.414116,93.228798 75.239334,100.003067 63.259087,107.105148  C59.615246,109.265274 57.773529,106.405266 54.934486,104.984756 \nM78.478706,27.973648  C73.434326,25.075504 68.475571,22.007710 63.289600,19.390081  C61.867535,18.672291 59.408554,18.656862 58.031178,19.416918  C47.266243,25.357176 36.583080,31.455883 26.057961,37.809315  C24.494617,38.753017 23.025360,41.267166 22.983904,43.088261  C22.711267,55.064632 22.713299,67.053032 22.977274,79.029770  C23.017942,80.874924 24.406055,83.443954 25.955465,84.380722  C36.475986,90.741379 47.161758,96.835831 57.925301,102.778740  C59.326496,103.552383 61.856071,103.653381 63.222660,102.901741  C74.142372,96.895714 84.967384,90.708412 95.650970,84.292809  C97.118301,83.411682 98.447189,80.985245 98.482819,79.246429  C98.728218,67.268883 98.769386,55.279861 98.457169,43.305454  C98.405952,41.340847 96.739838,38.759415 95.043144,37.620167  C89.950134,34.200478 84.472672,31.353376 78.478706,27.973648 \nz"}),/*#__PURE__*/index_js_default().createElement("path",{fill:"#040E1D",opacity:"1.000000",stroke:"none",d:"\nM78.811966,28.128246  C84.472672,31.353376 89.950134,34.200478 95.043144,37.620167  C96.739838,38.759415 98.405952,41.340847 98.457169,43.305454  C98.769386,55.279861 98.728218,67.268883 98.482819,79.246429  C98.447189,80.985245 97.118301,83.411682 95.650970,84.292809  C84.967384,90.708412 74.142372,96.895714 63.222660,102.901741  C61.856071,103.653381 59.326496,103.552383 57.925301,102.778740  C47.161758,96.835831 36.475986,90.741379 25.955465,84.380722  C24.406055,83.443954 23.017942,80.874924 22.977274,79.029770  C22.713299,67.053032 22.711267,55.064632 22.983904,43.088261  C23.025360,41.267166 24.494617,38.753017 26.057961,37.809315  C36.583080,31.455883 47.266243,25.357176 58.031178,19.416918  C59.408554,18.656862 61.867535,18.672291 63.289600,19.390081  C68.475571,22.007710 73.434326,25.075504 78.811966,28.128246 \nM63.027084,58.447029  C62.265572,60.446468 61.504063,62.445911 60.797871,64.300110  C56.567631,59.377850 58.715328,50.367886 50.169132,48.436188  C52.227421,55.764565 54.875565,62.733421 58.011871,69.475182  C58.396839,70.302704 62.736698,70.525894 62.976284,69.998688  C66.152122,63.010284 68.922081,55.837433 71.793388,48.710640  C71.227356,48.265530 70.661316,47.820415 70.095276,47.375301  C68.671593,48.658451 66.899712,49.721241 65.912750,51.280773  C64.690475,53.212135 64.119072,55.555401 63.027084,58.447029 \nz"}),/*#__PURE__*/index_js_default().createElement("path",{fill:"#EAEBED",opacity:"1.000000",stroke:"none",d:"\nM63.146790,58.083878  C64.119072,55.555401 64.690475,53.212135 65.912750,51.280773  C66.899712,49.721241 68.671593,48.658451 70.095276,47.375301  C70.661316,47.820415 71.227356,48.265530 71.793388,48.710640  C68.922081,55.837433 66.152122,63.010284 62.976284,69.998688  C62.736698,70.525894 58.396839,70.302704 58.011871,69.475182  C54.875565,62.733421 52.227421,55.764565 50.169132,48.436188  C58.715328,50.367886 56.567631,59.377850 60.797871,64.300110  C61.504063,62.445911 62.265572,60.446468 63.146790,58.083878 \nz"}))));/* harmony default export */ const logo = (IconLogo);
;// CONCATENATED MODULE: ./src/components/icons/playstore.js
const IconPlayStore=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",x:"0px",y:"0px",viewBox:"0 0 512.001 512.001"},/*#__PURE__*/index_js_default().createElement("title",null,"Google Play Store"),/*#__PURE__*/index_js_default().createElement("path",{d:"M464.252,212.09L99.624,8.07C84.247-1.873,64.754-2.691,48.574,5.967C32.183,14.74,22,31.737,22,50.329v411.342 c0,18.592,10.183,35.59,26.573,44.361c16.097,8.617,35.593,7.891,51.052-2.101l364.628-204.022 c16.121-9.02,25.747-25.435,25.747-43.908C490,237.527,480.374,221.111,464.252,212.09z M341.677,181.943l-50.339,50.339 L113.108,54.051L341.677,181.943z M55.544,467.323V44.676L267.621,256L55.544,467.323z M113.108,457.949l178.232-178.231 l50.339,50.339L113.108,457.949z M447.874,270.637l-75.779,42.401l-57.038-57.037l57.037-57.037l75.778,42.4 c7.746,4.335,8.583,11.68,8.583,14.637C456.455,258.958,455.62,266.302,447.874,270.637z"}));/* harmony default export */ const playstore = (IconPlayStore);
;// CONCATENATED MODULE: ./src/components/icons/star.js
const IconStar=()=>/*#__PURE__*/index_js_default().createElement("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-star"},/*#__PURE__*/index_js_default().createElement("title",null,"Star"),/*#__PURE__*/index_js_default().createElement("polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"}));/* harmony default export */ const star = (IconStar);
;// CONCATENATED MODULE: ./src/components/icons/twitter.js
const IconTwitter=()=>/*#__PURE__*/index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-twitter"},/*#__PURE__*/index_js_default().createElement("title",null,"Twitter"),/*#__PURE__*/index_js_default().createElement("path",{d:"M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"}));/* harmony default export */ const twitter = (IconTwitter);
...
var dist = __webpack_require__(9089);
;// CONCATENATED MODULE: ./src/components/head.js
const TRACKING_ID="G-JNP6EY70G0";// OUR_TRACKING_ID
dist/* default.initialize */.ZP.initialize([{trackingId:TRACKING_ID}]);const Head=({title,description,image})=>{useEffect(()=>{dist/* default.send */.ZP.send({hitType:"pageview",page:"/home",title:"website opened"});},[]);const{pathname}=(0,es.useLocation)();const{site}=(0,gatsby_browser_entry.useStaticQuery)("3539500889");const{defaultTitle,defaultDescription,siteUrl,defaultImage}=site.siteMetadata;const seo={title:title||defaultTitle,description:description||defaultDescription,image:`${siteUrl}${image||defaultImage}`,url:`${siteUrl}${pathname}`};return/*#__PURE__*/index_js_default().createElement(Helmet.Helmet,{title:title,defaultTitle:seo.title,titleTemplate:`%s | ${defaultTitle}`},/*#__PURE__*/index_js_default().createElement("html",{lang:"en"}),/*#__PURE__*/index_js_default().createElement("meta",{name:"description",content:seo.description}),/*#__PURE__*/index_js_default().createElement("meta",{name:"image",content:seo.image}),/*#__PURE__*/index_js_default().createElement("meta",{property:"og:title",content:seo.title}),/*#__PURE__*/index_js_default().createElement("meta",{property:"og:description",content:seo.description}),/*#__PURE__*/index_js_default().createElement("meta",{property:"og:image",content:seo.image}),/*#__PURE__*/index_js_default().createElement("meta",{property:"og:url",content:seo.url}),/*#__PURE__*/index_js_default().createElement("meta",{property:"og:type",content:"website"}),/*#__PURE__*/index_js_default().createElement("meta",{name:"google-site-verification",content:"DCl7VAf9tcz6eD9gb67NfkNnJ1PKRNcg8qQiwpbx9Lk"}));};/* harmony default export */ const head = (Head);Head.propTypes={title:(prop_types_default()).string,description:(prop_types_default()).string,image:(prop_types_default()).string};Head.defaultProps={title:null,description:null,image:null};
...
const mixins_button=(0,styled_components_esm.css)(["color:var(--green);background-color:transparent;border:1px solid var(--green);border-radius:var(--border-radius);font-size:var(--fz-xs);font-family:var(--font-mono);line-height:1;text-decoration:none;cursor:pointer;transition:var(--transition);padding:1.25rem 1.75rem;&:hover,&:focus,&:active{background-color:var(--green-tint);outline:none;}&:after{display:none !important;}"]);const mixins={flexCenter:(0,styled_components_esm.css)(["display:flex;justify-content:center;align-items:center;"]),flexBetween:(0,styled_components_esm.css)(["display:flex;justify-content:space-between;align-items:center;"]),link:(0,styled_components_esm.css)(["display:inline-block;text-decoration:none;text-decoration-skip-ink:auto;color:inherit;position:relative;transition:var(--transition);&:hover,&:active,&:focus{color:var(--green);outline:0;}"]),inlineLink:(0,styled_components_esm.css)(["display:inline-block;text-decoration:none;text-decoration-skip-ink:auto;position:relative;transition:var(--transition);color:var(--green);&:hover,&:focus,&:active{color:var(--green);outline:0;&:after{width:100%;}& > *{color:var(--green) !important;transition:var(--transition);}}&:after{content:'';display:block;width:0;height:1px;position:relative;bottom:0.37em;background-color:var(--green);transition:var(--transition);opacity:0.5;}"]),button: mixins_button,smallButton:(0,styled_components_esm.css)(["color:var(--green);background-color:transparent;border:1px solid var(--green);border-radius:var(--border-radius);padding:0.75rem 1rem;font-size:var(--fz-xs);font-family:var(--font-mono);line-height:1;text-decoration:none;cursor:pointer;transition:var(--transition);&:hover,&:focus,&:active{background-color:var(--green-tint);outline:none;}&:after{display:none !important;}"]),bigButton:(0,styled_components_esm.css)(["color:var(--green);background-color:transparent;border:1px solid var(--green);border-radius:var(--border-radius);padding:1.25rem 1.75rem;font-size:var(--fz-sm);font-family:var(--font-mono);line-height:1;text-decoration:none;cursor:pointer;transition:var(--transition);&:hover,&:focus,&:active{background-color:var(--green-tint);outline:none;}&:after{display:none !important;}"]),boxShadow:(0,styled_components_esm.css)(["box-shadow:0 10px 30px -15px var(--navy-shadow);transition:var(--transition);&:hover,&:focus{box-shadow:0 20px 30px -15px var(--navy-shadow);}"]),fancyList:(0,styled_components_esm.css)(["padding:0;margin:0;list-style:none;font-size:var(--fz-lg);li{position:relative;padding-left:30px;margin-bottom:10px;&:before{content:'\u25B9';position:absolute;left:0;color:var(--green);}}"]),resetList:(0,styled_components_esm.css)(["list-style:none;padding:0;margin:0;"])};/* harmony default export */ const styles_mixins = (mixins);
;// CONCATENATED MODULE: ./src/styles/theme.js
const theme={bp:{mobileS:`max-width: 330px`,mobileM:`max-width: 400px`,mobileL:`max-width: 480px`,tabletS:`max-width: 600px`,tabletL:`max-width: 768px`,desktopXS:`max-width: 900px`,desktopS:`max-width: 1080px`,desktopM:`max-width: 1200px`,desktopL:`max-width: 1400px`},mixins: styles_mixins};/* harmony default export */ const styles_theme = (theme);
...
const nav_TRACKING_ID="G-JNP6EY70G0";// OUR_TRACKING_ID
dist/* default.initialize */.ZP.initialize([{trackingId:nav_TRACKING_ID}]);const StyledHeader=styled_components_esm["default"].header.withConfig({displayName:"nav__StyledHeader",componentId:"sc-ghklvd-0"})(["",";position:fixed;top:0;z-index:11;padding:0px 50px;width:100%;height:var(--nav-height);background-color:rgba(10,25,47,0.85);filter:none !important;pointer-events:auto !important;user-select:auto !important;backdrop-filter:blur(10px);transition:var(--transition);@media (max-width:1080px){padding:0 40px;}@media (max-width:768px){padding:0 25px;}@media (prefers-reduced-motion:no-preference){",";",";}"],({theme})=>theme.mixins.flexBetween,props=>props.scrollDirection==='up'&&!props.scrolledToTop&&(0,styled_components_esm.css)(["height:var(--nav-scroll-height);transform:translateY(0px);background-color:rgba(10,25,47,0.85);box-shadow:0 10px 30px -10px var(--navy-shadow);"]),props=>props.scrollDirection==='down'&&!props.scrolledToTop&&(0,styled_components_esm.css)(["height:var(--nav-scroll-height);transform:translateY(calc(var(--nav-scroll-height) * -1));box-shadow:0 10px 30px -10px var(--navy-shadow);"]));const StyledNav=styled_components_esm["default"].nav.withConfig({displayName:"nav__StyledNav",componentId:"sc-ghklvd-1"})(["",";position:relative;width:100%;color:var(--lightest-slate);font-family:var(--font-mono);counter-reset:item 0;z-index:12;.logo{",";a{color:var(--green);width:42px;height:42px;&:hover,&:focus{svg{fill:var(--green-tint);}}svg{fill:none;transition:var(--transition);user-select:none;}}}"],({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.flexCenter);const StyledLinks=styled_components_esm["default"].div.withConfig({displayName:"nav__StyledLinks",componentId:"sc-ghklvd-2"})(["display:flex;align-items:center;@media (max-width:768px){display:none;}ol{",";padding:0;margin:0;list-style:none;li{margin:0 5px;position:relative;counter-increment:item 1;font-size:var(--fz-xs);a{padding:10px;&:before{content:'0' counter(item) '.';margin-right:5px;color:var(--green);font-size:var(--fz-xxs);text-align:right;}}}}.resume-button{",";margin-left:15px;font-size:var(--fz-xs);}"],({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.smallButton);const Nav=({isHome})=>{const{0:isMounted,1:setIsMounted}=(0,index_js_.useState)(!isHome);const scrollDirection=(0,hooks/* useScrollDirection */.C7)('down');const{0:scrolledToTop,1:setScrolledToTop}=(0,index_js_.useState)(true);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();const handleScroll=()=>{setScrolledToTop(window.pageYOffset<50);};(0,index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}const timeout=setTimeout(()=>{setIsMounted(true);},100);window.addEventListener('scroll',handleScroll);return()=>{clearTimeout(timeout);window.removeEventListener('scroll',handleScroll);};},[]);const timeout=isHome?utils/* loaderDelay */.Cs:0;const fadeClass=isHome?'fade':'';const fadeDownClass=isHome?'fadedown':'';const Logo=/*#__PURE__*/index_js_default().createElement("div",{className:"logo",tabIndex:"-1"},isHome?/*#__PURE__*/index_js_default().createElement("a",{href:"/","aria-label":"home"},/*#__PURE__*/index_js_default().createElement(icons/* IconLogo */.mp,null)):/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/","aria-label":"home"},/*#__PURE__*/index_js_default().createElement(icons/* IconLogo */.mp,null)));const ResumeLink=/*#__PURE__*/index_js_default().createElement("a",{className:"resume-button",href:"/resume.pdf",target:"_blank",rel:"noopener noreferrer"},"Resume");return/*#__PURE__*/index_js_default().createElement(StyledHeader,{scrollDirection:scrollDirection,scrolledToTop:scrolledToTop},/*#__PURE__*/index_js_default().createElement(StyledNav,null,prefersReducedMotion?/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(StyledLinks,null,/*#__PURE__*/index_js_default().createElement("ol",null,config.navLinks&&config.navLinks.map(({url,name},i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:url},name)))),/*#__PURE__*/index_js_default().createElement("div",{onClick:()=>{dist/* default.send */.ZP.send({hitType:"Resume downloaded",page:"/resume",title:"Resume downloaded"});}},ResumeLink)),/*#__PURE__*/index_js_default().createElement(menu,null)):/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{component:null},isMounted&&/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{classNames:fadeClass,timeout:timeout},/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,Logo))),/*#__PURE__*/index_js_default().createElement(StyledLinks,null,/*#__PURE__*/index_js_default().createElement("ol",null,/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{component:null},isMounted&&config.navLinks&&config.navLinks.map(({url,name},i)=>/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{key:i,classNames:fadeDownClass,timeout:timeout},/*#__PURE__*/index_js_default().createElement("li",{key:i,style:{transitionDelay:`${isHome?i*100:0}ms`}},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:url},name)))))),/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{component:null},isMounted&&/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{classNames:fadeDownClass,timeout:timeout},/*#__PURE__*/index_js_default().createElement("div",{style:{transitionDelay:`${isHome?config.navLinks.length*100:0}ms`}},ResumeLink)))),/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{component:null},isMounted&&/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{classNames:fadeClass,timeout:timeout},/*#__PURE__*/index_js_default().createElement(menu,null))))));};Nav.propTypes={isHome:(prop_types_default()).bool};/* harmony default export */ const nav = (Nav);
;// CONCATENATED MODULE: ./src/components/menu.js
const StyledMenu=styled_components_esm["default"].div.withConfig({displayName:"menu__StyledMenu",componentId:"sc-sdn9y6-0"})(["display:none;@media (max-width:768px){display:block;}"]);const StyledHamburgerButton=styled_components_esm["default"].button.withConfig({displayName:"menu__StyledHamburgerButton",componentId:"sc-sdn9y6-1"})(["display:none;@media (max-width:768px){",";position:relative;z-index:10;margin-right:-15px;padding:15px;border:0;background-color:transparent;color:inherit;text-transform:none;transition-timing-function:linear;transition-duration:0.15s;transition-property:opacity,filter;}.ham-box{display:inline-block;position:relative;width:var(--hamburger-width);height:24px;}.ham-box-inner{position:absolute;top:50%;right:0;width:var(--hamburger-width);height:2px;border-radius:var(--border-radius);background-color:var(--green);transition-duration:0.22s;transition-property:transform;transition-delay:",";transform:rotate(",");transition-timing-function:cubic-bezier( "," );&:before,&:after{content:'';display:block;position:absolute;left:auto;right:0;width:var(--hamburger-width);height:2px;border-radius:4px;background-color:var(--green);transition-timing-function:ease;transition-duration:0.15s;transition-property:transform;}&:before{width:",";top:",";opacity:",";transition:",";}&:after{width:",";bottom:",";transform:rotate(",");transition:",";}}"],({theme})=>theme.mixins.flexCenter,props=>props.menuOpen?`0.12s`:`0s`,props=>props.menuOpen?`225deg`:`0deg`,props=>props.menuOpen?`0.215, 0.61, 0.355, 1`:`0.55, 0.055, 0.675, 0.19`,props=>props.menuOpen?`100%`:`120%`,props=>props.menuOpen?`0`:`-10px`,props=>props.menuOpen?0:1,({menuOpen})=>menuOpen?'var(--ham-before-active)':'var(--ham-before)',props=>props.menuOpen?`100%`:`80%`,props=>props.menuOpen?`0`:`-10px`,props=>props.menuOpen?`-90deg`:`0`,({menuOpen})=>menuOpen?'var(--ham-after-active)':'var(--ham-after)');const StyledSidebar=styled_components_esm["default"].aside.withConfig({displayName:"menu__StyledSidebar",componentId:"sc-sdn9y6-2"})(["display:none;@media (max-width:768px){",";position:fixed;top:0;bottom:0;right:0;padding:50px 10px;width:min(75vw,400px);height:100vh;outline:0;background-color:var(--light-navy);box-shadow:-10px 0px 30px -15px var(--navy-shadow);z-index:9;transform:translateX(","vw);visibility:",";transition:var(--transition);}nav{",";width:100%;flex-direction:column;color:var(--lightest-slate);font-family:var(--font-mono);text-align:center;}ol{padding:0;margin:0;list-style:none;width:100%;li{position:relative;margin:0 auto 20px;counter-increment:item 1;font-size:clamp(var(--fz-sm),4vw,var(--fz-lg));@media (max-width:600px){margin:0 auto 10px;}&:before{content:'0' counter(item) '.';display:block;margin-bottom:5px;color:var(--green);font-size:var(--fz-sm);}}a{",";width:100%;padding:3px 20px 20px;}}.resume-link{",";padding:18px 50px;margin:10% auto 0;width:max-content;}"],({theme})=>theme.mixins.flexCenter,props=>props.menuOpen?0:100,props=>props.menuOpen?'visible':'hidden',({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.link,({theme})=>theme.mixins.bigButton);const Menu=()=>{const{0:menuOpen,1:setMenuOpen}=(0,index_js_.useState)(false);const toggleMenu=()=>setMenuOpen(!menuOpen);const buttonRef=(0,index_js_.useRef)(null);const navRef=(0,index_js_.useRef)(null);let menuFocusables;let firstFocusableEl;let lastFocusableEl;const setFocusables=()=>{menuFocusables=[buttonRef.current,...Array.from(navRef.current.querySelectorAll('a'))];firstFocusableEl=menuFocusables[0];lastFocusableEl=menuFocusables[menuFocusables.length-1];};const handleBackwardTab=e=>{if(document.activeElement===firstFocusableEl){e.preventDefault();lastFocusableEl.focus();}};const handleForwardTab=e=>{if(document.activeElement===lastFocusableEl){e.preventDefault();firstFocusableEl.focus();}};const onKeyDown=e=>{switch(e.key){case utils/* KEY_CODES.ESCAPE */.nx.ESCAPE:case utils/* KEY_CODES.ESCAPE_IE11 */.nx.ESCAPE_IE11:{setMenuOpen(false);break;}case utils/* KEY_CODES.TAB */.nx.TAB:{if(menuFocusables&&menuFocusables.length===1){e.preventDefault();break;}if(e.shiftKey){handleBackwardTab(e);}else{handleForwardTab(e);}break;}default:{break;}}};const onResize=e=>{if(e.currentTarget.innerWidth>768){setMenuOpen(false);}};(0,index_js_.useEffect)(()=>{document.addEventListener('keydown',onKeyDown);window.addEventListener('resize',onResize);setFocusables();return()=>{document.removeEventListener('keydown',onKeyDown);window.removeEventListener('resize',onResize);};},[]);const wrapperRef=(0,index_js_.useRef)();(0,hooks/* useOnClickOutside */.t$)(wrapperRef,()=>setMenuOpen(false));return/*#__PURE__*/index_js_default().createElement(StyledMenu,null,/*#__PURE__*/index_js_default().createElement(Helmet.Helmet,null,/*#__PURE__*/index_js_default().createElement("body",{className:menuOpen?'blur':''})),/*#__PURE__*/index_js_default().createElement("div",{ref:wrapperRef},/*#__PURE__*/index_js_default().createElement(StyledHamburgerButton,{onClick:toggleMenu,menuOpen:menuOpen,ref:buttonRef,"aria-label":"Menu"},/*#__PURE__*/index_js_default().createElement("div",{className:"ham-box"},/*#__PURE__*/index_js_default().createElement("div",{className:"ham-box-inner"}))),/*#__PURE__*/index_js_default().createElement(StyledSidebar,{menuOpen:menuOpen,"aria-hidden":!menuOpen,tabIndex:menuOpen?1:-1},/*#__PURE__*/index_js_default().createElement("nav",{ref:navRef},config.navLinks&&/*#__PURE__*/index_js_default().createElement("ol",null,config.navLinks.map(({url,name},i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:url,onClick:()=>setMenuOpen(false)},name)))),/*#__PURE__*/index_js_default().createElement("a",{href:"/resume.pdf",className:"resume-link"},"Resume")))));};/* harmony default export */ const menu = (Menu);
;// CONCATENATED MODULE: ./src/components/side.js
const StyledSideElement=styled_components_esm["default"].div.withConfig({displayName:"side__StyledSideElement",componentId:"sc-1duznzb-0"})(["width:40px;position:fixed;bottom:0;left:",";right:",";z-index:10;color:var(--light-slate);@media (max-width:1080px){left:",";right:",";}@media (max-width:768px){display:none;}"],props=>props.orientation==='left'?'40px':'auto',props=>props.orientation==='left'?'auto':'40px',props=>props.orientation==='left'?'20px':'auto',props=>props.orientation==='left'?'auto':'20px');const Side=({children,isHome,orientation})=>{const{0:isMounted,1:setIsMounted}=(0,index_js_.useState)(!isHome);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();(0,index_js_.useEffect)(()=>{if(!isHome||prefersReducedMotion){return;}const timeout=setTimeout(()=>setIsMounted(true),utils/* loaderDelay */.Cs);return()=>clearTimeout(timeout);},[]);return/*#__PURE__*/index_js_default().createElement(StyledSideElement,{orientation:orientation},prefersReducedMotion?/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,children):/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{component:null},isMounted&&/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{classNames:isHome?'fade':'',timeout:isHome?utils/* loaderDelay */.Cs:0},children)));};Side.propTypes={children:(prop_types_default()).node.isRequired,isHome:(prop_types_default()).bool,orientation:(prop_types_default()).string};/* harmony default export */ const side = (Side);
;// CONCATENATED MODULE: ./src/components/social.js
const StyledSocialList=styled_components_esm["default"].ul.withConfig({displayName:"social__StyledSocialList",componentId:"sc-anu6nt-0"})(["display:flex;flex-direction:column;align-items:center;margin:0;padding:0;list-style:none;&:after{content:'';display:block;width:1px;height:90px;margin:0 auto;background-color:var(--light-slate);}li{&:last-of-type{margin-bottom:20px;}a{padding:10px;&:hover,&:focus{transform:translateY(-3px);}svg{width:20px;height:20px;}}}"]);const Social=({isHome})=>/*#__PURE__*/index_js_default().createElement(side,{isHome:isHome,orientation:"left"},/*#__PURE__*/index_js_default().createElement(StyledSocialList,null,config.socialMedia&&config.socialMedia.map(({url,name},i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},/*#__PURE__*/index_js_default().createElement("a",{href:url,"aria-label":name,target:"_blank",rel:"noreferrer"},/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:name}))))));Social.propTypes={isHome:(prop_types_default()).bool};/* harmony default export */ const social = (Social);
;// CONCATENATED MODULE: ./src/components/email.js
const StyledLinkWrapper=styled_components_esm["default"].div.withConfig({displayName:"email__StyledLinkWrapper",componentId:"sc-2epoq-0"})(["display:flex;flex-direction:column;align-items:center;position:relative;&:after{content:'';display:block;width:1px;height:90px;margin:0 auto;background-color:var(--light-slate);}a{margin:20px auto;padding:10px;font-family:var(--font-mono);font-size:var(--fz-xxs);line-height:var(--fz-lg);letter-spacing:0.1em;writing-mode:vertical-rl;&:hover,&:focus{transform:translateY(-3px);}}"]);const Email=({isHome})=>/*#__PURE__*/index_js_default().createElement(side,{isHome:isHome,orientation:"right"},/*#__PURE__*/index_js_default().createElement(StyledLinkWrapper,null,/*#__PURE__*/index_js_default().createElement("a",{href:`mailto:${config.email}`},config.email)));Email.propTypes={isHome:(prop_types_default()).bool};/* harmony default export */ const email = (Email);
;// CONCATENATED MODULE: ./src/components/footer.js
const StyledFooter=styled_components_esm["default"].footer.withConfig({displayName:"footer__StyledFooter",componentId:"sc-4jwnt4-0"})(["",";flex-direction:column;height:auto;min-height:70px;padding:15px;text-align:center;"],({theme})=>theme.mixins.flexCenter);const StyledSocialLinks=styled_components_esm["default"].div.withConfig({displayName:"footer__StyledSocialLinks",componentId:"sc-4jwnt4-1"})(["display:none;@media (max-width:768px){display:block;width:100%;max-width:270px;margin:0 auto 10px;color:var(--light-slate);}ul{",";padding:0;margin:0;list-style:none;a{padding:10px;svg{width:20px;height:20px;}}}"],({theme})=>theme.mixins.flexBetween);const StyledCredit=styled_components_esm["default"].div.withConfig({displayName:"footer__StyledCredit",componentId:"sc-4jwnt4-2"})(["color:var(--light-slate);font-family:var(--font-mono);font-size:var(--fz-xxs);line-height:1;a{padding:10px;}.github-stats{margin-top:10px;& > span{display:inline-flex;align-items:center;margin:0 7px;}svg{display:inline-block;margin-right:5px;width:14px;height:14px;}}"]);const Footer=()=>{const{0:githubInfo,1:setGitHubInfo}=(0,index_js_.useState)({stars:null,forks:null});(0,index_js_.useEffect)(()=>{if(false){}fetch('https://api.github.com/repos/bchiang7/v4').then(response=>response.json()).then(json=>{const{stargazers_count,forks_count}=json;setGitHubInfo({stars:stargazers_count,forks:forks_count});}).catch(e=>console.error(e));},[]);return/*#__PURE__*/index_js_default().createElement(StyledFooter,null,/*#__PURE__*/index_js_default().createElement(StyledSocialLinks,null,/*#__PURE__*/index_js_default().createElement("ul",null,config.socialMedia&&config.socialMedia.map(({name,url},i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},/*#__PURE__*/index_js_default().createElement("a",{href:url,"aria-label":name},/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:name})))))),/*#__PURE__*/index_js_default().createElement(StyledCredit,{tabindex:"-1"},/*#__PURE__*/index_js_default().createElement("a",{href:"https://github.com/bchiang7/v4"},githubInfo.stars&&githubInfo.forks&&/*#__PURE__*/index_js_default().createElement("div",{className:"github-stats"},/*#__PURE__*/index_js_default().createElement("span",null,/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:"Star"}),/*#__PURE__*/index_js_default().createElement("span",null,githubInfo.stars.toLocaleString())),/*#__PURE__*/index_js_default().createElement("span",null,/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:"Fork"}),/*#__PURE__*/index_js_default().createElement("span",null,githubInfo.forks.toLocaleString()))))));};Footer.propTypes={githubInfo:(prop_types_default()).object};/* harmony default export */ const footer = ((/* unused pure expression or super */ null && (Footer)));
;// CONCATENATED MODULE: ./src/components/sections/hero.js
// import { email } from '@config';
const StyledHeroSection=styled_components_esm["default"].section.withConfig({displayName:"hero__StyledHeroSection",componentId:"sc-116xg8t-0"})(["",";flex-direction:column;align-items:flex-start;min-height:100vh;padding:0;@media (max-width:480px) and (min-height:700px){padding-bottom:10vh;}h1{margin:0 0 30px 4px;color:var(--green);font-family:var(--font-mono);font-size:clamp(var(--fz-sm),5vw,var(--fz-md));font-weight:400;@media (max-width:480px){margin:0 0 20px 2px;}}h3{margin-top:10px;color:var(--slate);line-height:0.9;}p{margin:20px 0 0;max-width:540px;}.email-link{",";margin-top:50px;}"],({theme})=>theme.mixins.flexCenter,({theme})=>theme.mixins.bigButton);const Hero=()=>{const{0:isMounted,1:setIsMounted}=(0,index_js_.useState)(false);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();(0,index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}const timeout=setTimeout(()=>setIsMounted(true),utils/* navDelay */.fb);return()=>clearTimeout(timeout);},[]);const one=/*#__PURE__*/index_js_default().createElement("h1",null,"Hi, my name is");const two=/*#__PURE__*/index_js_default().createElement("h2",{className:"big-heading"},"Vamshi Saggurthi.");const three=/*#__PURE__*/index_js_default().createElement("h3",{className:"big-heading"},"I am Full Stack Software Engineer.");const four=/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement("p",null,"A New York based software engineer specializing in building  exceptional digital experiences and seamless data flows.Currently purusing  master's in CS @Rutgers University Graduating in May 2023."));// const five = (
//   <a
...
//   </a>
// );
const items=[two,three,four];return/*#__PURE__*/index_js_default().createElement(StyledHeroSection,null,prefersReducedMotion?/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,items.map((item,i)=>/*#__PURE__*/index_js_default().createElement("div",{key:i},item))):/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{component:null},isMounted&&items.map((item,i)=>/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{key:i,classNames:"fadeup",timeout:utils/* loaderDelay */.Cs},/*#__PURE__*/index_js_default().createElement("div",{style:{transitionDelay:`${i+1}00ms`}},item)))));};/* harmony default export */ const hero = (Hero);
// EXTERNAL MODULE: ./node_modules/common-tags/es/index.js + 41 modules
var common_tags_es = __webpack_require__(5863);
...
// EXTERNAL MODULE: ./src/utils/sr.js
var sr = __webpack_require__(6179);
;// CONCATENATED MODULE: ./src/components/sections/about.js
const StyledAboutSection=styled_components_esm["default"].section.withConfig({displayName:"about__StyledAboutSection",componentId:"sc-1ownso9-0"})(["max-width:900px;.inner{display:grid;grid-template-columns:3fr 2fr;grid-gap:50px;@media (max-width:768px){display:block;}}"]);const StyledText=styled_components_esm["default"].div.withConfig({displayName:"about__StyledText",componentId:"sc-1ownso9-1"})(["ul.skills-list{display:grid;grid-template-columns:repeat(2,minmax(140px,200px));grid-gap:0 10px;padding:0;margin:20px 0 0 0;overflow:hidden;list-style:none;li{position:relative;margin-bottom:10px;padding-left:20px;font-family:var(--font-mono);font-size:var(--fz-xs);&:before{content:'\u25B9';position:absolute;left:0;color:var(--green);font-size:var(--fz-sm);line-height:12px;}}}"]);const StyledPic=styled_components_esm["default"].div.withConfig({displayName:"about__StyledPic",componentId:"sc-1ownso9-2"})(["position:relative;max-width:300px;@media (max-width:768px){margin:50px auto 0;width:70%;}.wrapper{",";display:block;position:relative;width:100%;border-radius:var(--border-radius);background-color:var(--green);&:hover,&:focus{background:transparent;outline:0;&:after{top:15px;left:15px;}.img{filter:none;mix-blend-mode:normal;}}.img{position:relative;border-radius:var(--border-radius);mix-blend-mode:multiply;filter:grayscale(100%) contrast(1);transition:var(--transition);}&:before,&:after{content:'';display:block;position:absolute;width:100%;height:100%;border-radius:var(--border-radius);transition:var(--transition);}&:before{top:0;left:0;background-color:var(--navy);mix-blend-mode:screen;}&:after{border:2px solid var(--green);top:20px;left:20px;z-index:-1;}}"],({theme})=>theme.mixins.boxShadow);const About=()=>{const revealContainer=(0,index_js_.useRef)(null);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();(0,index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default.reveal */.Z.reveal(revealContainer.current,(0,config.srConfig)());},[]);const skills=['Python','Java','JavaScript (ES6+)','React','Dash'];return/*#__PURE__*/index_js_default().createElement(StyledAboutSection,{id:"about",ref:revealContainer},/*#__PURE__*/index_js_default().createElement("h2",{className:"numbered-heading"},"About Me"),/*#__PURE__*/index_js_default().createElement("div",{className:"inner"},/*#__PURE__*/index_js_default().createElement(StyledText,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("p",null,"Hello! My name is Vamshi and I enjoy creating things that live on the internet. My interest in software development started back in 2015 when I decided to try editing custom WordPress themes for a blog \u2014 turns out hacking together a custom logos and branding taught me a lot about HTML & CSS!"),/*#__PURE__*/index_js_default().createElement("p",null,"Fast-forward to today, and I\u2019ve had the privilege of working in",' ',/*#__PURE__*/index_js_default().createElement("a",{href:"https://www.striim.com/"}," start-ups"),",",' ',/*#__PURE__*/index_js_default().createElement("a",{href:"https://www.3ds.com/"}," huge corporation's"),", and",' ',/*#__PURE__*/index_js_default().createElement("a",{href:"https://www.mitrofanova-lab.org/"},"contribute to cancer research "),". My main focus these days is building accessible, high perfomant systems inclusive of all parts of the stack(Frontend+Backend+Database+Deployment)."),/*#__PURE__*/index_js_default().createElement("p",null,"I also recently  have been building data streams for huge computational anaylis and real time analytics deriving some key insights which is quite exciting."),/*#__PURE__*/index_js_default().createElement("p",null,"Here are a few technologies I\u2019ve been working with recently:")),/*#__PURE__*/index_js_default().createElement("ul",{className:"skills-list"},skills&&skills.map((skill,i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},skill)))),/*#__PURE__*/index_js_default().createElement(StyledPic,null,/*#__PURE__*/index_js_default().createElement("div",{className:"wrapper"},/*#__PURE__*/index_js_default().createElement(J,{className:"img",src:"../../images/me.jpg",width:500,quality:95,formats:['AUTO','WEBP','AVIF'],alt:"Headshot",__imageData:__webpack_require__(1868)})))));};/* harmony default export */ const about = (About);
;// CONCATENATED MODULE: ./src/components/sections/jobs.js
const StyledJobsSection=styled_components_esm["default"].section.withConfig({displayName:"jobs__StyledJobsSection",componentId:"sc-59sdss-0"})(["max-width:700px;.inner{display:flex;@media (max-width:600px){display:block;}@media (min-width:700px){min-height:340px;}}"]);const StyledTabList=styled_components_esm["default"].div.withConfig({displayName:"jobs__StyledTabList",componentId:"sc-59sdss-1"})(["position:relative;z-index:3;width:max-content;padding:0;margin:0;list-style:none;@media (max-width:600px){display:flex;overflow-x:auto;width:calc(100% + 100px);padding-left:50px;margin-left:-50px;margin-bottom:30px;}@media (max-width:480px){width:calc(100% + 50px);padding-left:25px;margin-left:-25px;}li{&:first-of-type{@media (max-width:600px){margin-left:50px;}@media (max-width:480px){margin-left:25px;}}&:last-of-type{@media (max-width:600px){padding-right:50px;}@media (max-width:480px){padding-right:25px;}}}"]);const StyledTabButton=styled_components_esm["default"].button.withConfig({displayName:"jobs__StyledTabButton",componentId:"sc-59sdss-2"})(["",";display:flex;align-items:center;width:100%;height:var(--tab-height);padding:0 20px 2px;border-left:2px solid var(--lightest-navy);background-color:transparent;color:",";font-family:var(--font-mono);font-size:var(--fz-xs);text-align:left;white-space:nowrap;@media (max-width:768px){padding:0 15px 2px;}@media (max-width:600px){",";min-width:120px;padding:0 15px;border-left:0;border-bottom:2px solid var(--lightest-navy);text-align:center;}&:hover,&:focus{background-color:var(--light-navy);}"],({theme})=>theme.mixins.link,({isActive})=>isActive?'var(--green)':'var(--slate)',({theme})=>theme.mixins.flexCenter);const StyledHighlight=styled_components_esm["default"].div.withConfig({displayName:"jobs__StyledHighlight",componentId:"sc-59sdss-3"})(["position:absolute;top:0;left:0;z-index:10;width:2px;height:var(--tab-height);border-radius:var(--border-radius);background:var(--green);transform:translateY(calc("," * var(--tab-height)));transition:transform 0.25s cubic-bezier(0.645,0.045,0.355,1);transition-delay:0.1s;@media (max-width:600px){top:auto;bottom:0;width:100%;max-width:var(--tab-width);height:2px;margin-left:50px;transform:translateX(calc("," * var(--tab-width)));}@media (max-width:480px){margin-left:25px;}"],({activeTabId})=>activeTabId,({activeTabId})=>activeTabId);const StyledTabPanels=styled_components_esm["default"].div.withConfig({displayName:"jobs__StyledTabPanels",componentId:"sc-59sdss-4"})(["position:relative;width:100%;margin-left:20px;@media (max-width:600px){margin-left:0;}"]);const StyledTabPanel=styled_components_esm["default"].div.withConfig({displayName:"jobs__StyledTabPanel",componentId:"sc-59sdss-5"})(["width:100%;height:auto;padding:10px 5px;ul{",";}h3{margin-bottom:2px;font-size:var(--fz-xxl);font-weight:500;line-height:1.3;.company{color:var(--green);}}.range{margin-bottom:25px;color:var(--light-slate);font-family:var(--font-mono);font-size:var(--fz-xs);}"],({theme})=>theme.mixins.fancyList);const Jobs=()=>{const data=(0,gatsby_browser_entry.useStaticQuery)("604461682");const jobsData=data.jobs.edges;const{0:activeTabId,1:setActiveTabId}=(0,index_js_.useState)(0);const{0:tabFocus,1:setTabFocus}=(0,index_js_.useState)(null);const tabs=(0,index_js_.useRef)([]);const revealContainer=(0,index_js_.useRef)(null);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();(0,index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default.reveal */.Z.reveal(revealContainer.current,(0,config.srConfig)());},[]);const focusTab=()=>{if(tabs.current[tabFocus]){tabs.current[tabFocus].focus();return;}// If we're at the end, go to the start
...
(0,index_js_.useEffect)(()=>focusTab(),[tabFocus]);// Focus on tabs when using up & down arrow keys
const onKeyDown=e=>{switch(e.key){case utils/* KEY_CODES.ARROW_UP */.nx.ARROW_UP:{e.preventDefault();setTabFocus(tabFocus-1);break;}case utils/* KEY_CODES.ARROW_DOWN */.nx.ARROW_DOWN:{e.preventDefault();setTabFocus(tabFocus+1);break;}default:{break;}}};return/*#__PURE__*/index_js_default().createElement(StyledJobsSection,{id:"jobs",ref:revealContainer},/*#__PURE__*/index_js_default().createElement("h2",{className:"numbered-heading"},"Where I\u2019ve Worked"),/*#__PURE__*/index_js_default().createElement("div",{className:"inner"},/*#__PURE__*/index_js_default().createElement(StyledTabList,{role:"tablist","aria-label":"Job tabs",onKeyDown:e=>onKeyDown(e)},jobsData&&jobsData.map(({node},i)=>{const{company}=node.frontmatter;return/*#__PURE__*/index_js_default().createElement(StyledTabButton,{key:i,isActive:activeTabId===i,onClick:()=>setActiveTabId(i),ref:el=>tabs.current[i]=el,id:`tab-${i}`,role:"tab",tabIndex:activeTabId===i?'0':'-1',"aria-selected":activeTabId===i?true:false,"aria-controls":`panel-${i}`},/*#__PURE__*/index_js_default().createElement("span",null,company));}),/*#__PURE__*/index_js_default().createElement(StyledHighlight,{activeTabId:activeTabId})),/*#__PURE__*/index_js_default().createElement(StyledTabPanels,null,jobsData&&jobsData.map(({node},i)=>{const{frontmatter,html}=node;const{title,url,company,range}=frontmatter;return/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{key:i,in:activeTabId===i,timeout:250,classNames:"fade"},/*#__PURE__*/index_js_default().createElement(StyledTabPanel,{id:`panel-${i}`,role:"tabpanel",tabIndex:activeTabId===i?'0':'-1',"aria-labelledby":`tab-${i}`,"aria-hidden":activeTabId!==i,hidden:activeTabId!==i},/*#__PURE__*/index_js_default().createElement("h3",null,/*#__PURE__*/index_js_default().createElement("span",null,title),/*#__PURE__*/index_js_default().createElement("span",{className:"company"},"\xA0@\xA0",/*#__PURE__*/index_js_default().createElement("a",{href:url,className:"inline-link"},company))),/*#__PURE__*/index_js_default().createElement("p",{className:"range"},range),/*#__PURE__*/index_js_default().createElement("div",{dangerouslySetInnerHTML:{__html:html}})));}))));};/* harmony default export */ const jobs = (Jobs);
;// CONCATENATED MODULE: ./src/components/sections/featured.js
const StyledProjectsGrid=styled_components_esm["default"].ul.withConfig({displayName:"featured__StyledProjectsGrid",componentId:"sc-ywnbqt-0"})(["",";a{position:relative;z-index:1;}"],({theme})=>theme.mixins.resetList);const StyledProject=styled_components_esm["default"].li.withConfig({displayName:"featured__StyledProject",componentId:"sc-ywnbqt-1"})(["position:relative;display:grid;grid-gap:10px;grid-template-columns:repeat(12,1fr);align-items:center;@media (max-width:768px){",";}&:not(:last-of-type){margin-bottom:100px;@media (max-width:768px){margin-bottom:70px;}@media (max-width:480px){margin-bottom:30px;}}&:nth-of-type(odd){.project-content{grid-column:7 / -1;text-align:right;@media (max-width:1080px){grid-column:5 / -1;}@media (max-width:768px){grid-column:1 / -1;padding:40px 40px 30px;text-align:left;}@media (max-width:480px){padding:25px 25px 20px;}}.project-tech-list{justify-content:flex-end;@media (max-width:768px){justify-content:flex-start;}li{margin:0 0 5px 20px;@media (max-width:768px){margin:0 10px 5px 0;}}}.project-links{justify-content:flex-end;margin-left:0;margin-right:-10px;@media (max-width:768px){justify-content:flex-start;margin-left:-10px;margin-right:0;}}.project-image{grid-column:1 / 8;@media (max-width:768px){grid-column:1 / -1;}}}.project-content{position:relative;grid-column:1 / 7;grid-row:1 / -1;@media (max-width:1080px){grid-column:1 / 9;}@media (max-width:768px){display:flex;flex-direction:column;justify-content:center;height:100%;grid-column:1 / -1;padding:40px 40px 30px;z-index:5;}@media (max-width:480px){padding:30px 25px 20px;}}.project-overline{margin:10px 0;color:var(--green);font-family:var(--font-mono);font-size:var(--fz-xs);font-weight:400;}.project-title{color:var(--lightest-slate);font-size:clamp(24px,5vw,28px);@media (min-width:768px){margin:0 0 20px;}@media (max-width:768px){color:var(--white);a{position:static;&:before{content:'';display:block;position:absolute;z-index:0;width:100%;height:100%;top:0;left:0;}}}}.project-description{",";position:relative;z-index:2;padding:25px;border-radius:var(--border-radius);background-color:var(--light-navy);color:var(--light-slate);font-size:var(--fz-lg);@media (max-width:768px){padding:20px 0;background-color:transparent;box-shadow:none;&:hover{box-shadow:none;}}a{",";}strong{color:var(--white);font-weight:normal;}}.project-tech-list{display:flex;flex-wrap:wrap;position:relative;z-index:2;margin:25px 0 10px;padding:0;list-style:none;li{margin:0 20px 5px 0;color:var(--light-slate);font-family:var(--font-mono);font-size:var(--fz-xs);white-space:nowrap;}@media (max-width:768px){margin:10px 0;li{margin:0 10px 5px 0;color:var(--lightest-slate);}}}.project-links{display:flex;align-items:center;position:relative;margin-top:10px;margin-left:-10px;color:var(--lightest-slate);a{",";padding:10px;&.external{svg{width:22px;height:22px;margin-top:-4px;}}svg{width:20px;height:20px;}}.cta{",";margin:10px;}}.project-image{",";grid-column:6 / -1;grid-row:1 / -1;position:relative;z-index:1;@media (max-width:768px){grid-column:1 / -1;height:100%;opacity:0.25;}a{width:100%;height:100%;background-color:var(--green);border-radius:var(--border-radius);vertical-align:middle;&:hover,&:focus{background:transparent;outline:0;&:before,.img{background:transparent;filter:none;}}&:before{content:'';position:absolute;width:100%;height:100%;top:0;left:0;right:0;bottom:0;z-index:3;transition:var(--transition);background-color:var(--navy);mix-blend-mode:screen;}}.img{border-radius:var(--border-radius);mix-blend-mode:multiply;filter:grayscale(100%) contrast(1) brightness(90%);@media (max-width:768px){object-fit:cover;width:auto;height:100%;filter:grayscale(100%) contrast(1) brightness(50%);}}}"],({theme})=>theme.mixins.boxShadow,({theme})=>theme.mixins.boxShadow,({theme})=>theme.mixins.inlineLink,({theme})=>theme.mixins.flexCenter,({theme})=>theme.mixins.smallButton,({theme})=>theme.mixins.boxShadow);const Featured=()=>{const data=(0,gatsby_browser_entry.useStaticQuery)("2681795072");const featuredProjects=data.featured.edges.filter(({node})=>node);const revealTitle=(0,index_js_.useRef)(null);const revealProjects=(0,index_js_.useRef)([]);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();(0,index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default.reveal */.Z.reveal(revealTitle.current,(0,config.srConfig)());revealProjects.current.forEach((ref,i)=>sr/* default.reveal */.Z.reveal(ref,(0,config.srConfig)(i*100)));},[]);return/*#__PURE__*/index_js_default().createElement("section",{id:"projects"},/*#__PURE__*/index_js_default().createElement("h2",{className:"numbered-heading",ref:revealTitle},"Some Things I\u2019ve Built"),/*#__PURE__*/index_js_default().createElement(StyledProjectsGrid,null,featuredProjects&&featuredProjects.map(({node},i)=>{const{frontmatter,html}=node;const{external,title,tech,github,cover,cta}=frontmatter;const image=R(cover);return/*#__PURE__*/index_js_default().createElement(StyledProject,{key:i,ref:el=>revealProjects.current[i]=el},/*#__PURE__*/index_js_default().createElement("div",{className:"project-content"},/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("p",{className:"project-overline"},"Featured Project"),/*#__PURE__*/index_js_default().createElement("h3",{className:"project-title"},/*#__PURE__*/index_js_default().createElement("a",{href:external},title)),/*#__PURE__*/index_js_default().createElement("div",{className:"project-description",dangerouslySetInnerHTML:{__html:html}}),tech.length&&/*#__PURE__*/index_js_default().createElement("ul",{className:"project-tech-list"},tech.map((tech,i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},tech))),/*#__PURE__*/index_js_default().createElement("div",{className:"project-links"},cta&&/*#__PURE__*/index_js_default().createElement("a",{href:cta,"aria-label":"Course Link",className:"cta"},"Learn More"),github&&/*#__PURE__*/index_js_default().createElement("a",{href:github,"aria-label":"GitHub Link"},/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:"GitHub"})),external&&!cta&&/*#__PURE__*/index_js_default().createElement("a",{href:external,"aria-label":"External Link",className:"external"},/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:"External"}))))),/*#__PURE__*/index_js_default().createElement("div",{className:"project-image"},/*#__PURE__*/index_js_default().createElement("a",{href:external?external:github?github:'#'},/*#__PURE__*/index_js_default().createElement(Y,{image:image,alt:title,className:"img"}))));})));};/* harmony default export */ const featured = (Featured);
;// CONCATENATED MODULE: ./src/components/sections/projects.js
const StyledProjectsSection=styled_components_esm["default"].section.withConfig({displayName:"projects__StyledProjectsSection",componentId:"sc-1v1fime-0"})(["display:flex;flex-direction:column;align-items:center;h2{font-size:clamp(24px,5vw,var(--fz-heading));}.archive-link{font-family:var(--font-mono);font-size:var(--fz-sm);&:after{bottom:0.1em;}}.projects-grid{",";display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));grid-gap:15px;position:relative;margin-top:50px;@media (max-width:1080px){grid-template-columns:repeat(auto-fill,minmax(250px,1fr));}}.more-button{",";margin:80px auto 0;}"],({theme})=>theme.mixins.resetList,({theme})=>theme.mixins.button);const projects_StyledProject=styled_components_esm["default"].li.withConfig({displayName:"projects__StyledProject",componentId:"sc-1v1fime-1"})(["position:relative;cursor:default;transition:var(--transition);@media (prefers-reduced-motion:no-preference){&:hover,&:focus-within{.project-inner{transform:translateY(-7px);}}}a{position:relative;z-index:1;}.project-inner{",";",";flex-direction:column;align-items:flex-start;position:relative;height:100%;padding:2rem 1.75rem;border-radius:var(--border-radius);background-color:var(--light-navy);transition:var(--transition);}.project-top{",";margin-bottom:35px;.folder{color:var(--green);svg{width:40px;height:40px;}}.project-links{display:flex;align-items:center;margin-right:-10px;color:var(--light-slate);a{",";padding:5px 7px;&.external{svg{width:22px;height:22px;margin-top:-4px;}}svg{width:20px;height:20px;}}}}.project-title{margin:0 0 10px;color:var(--lightest-slate);font-size:var(--fz-xxl);a{position:static;&:before{content:'';display:block;position:absolute;z-index:0;width:100%;height:100%;top:0;left:0;}}}.project-description{color:var(--light-slate);font-size:17px;a{",";}}.project-tech-list{display:flex;align-items:flex-end;flex-grow:1;flex-wrap:wrap;padding:0;margin:20px 0 0 0;list-style:none;li{font-family:var(--font-mono);font-size:var(--fz-xxs);line-height:1.75;&:not(:last-of-type){margin-right:15px;}}}"],({theme})=>theme.mixins.boxShadow,({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.flexCenter,({theme})=>theme.mixins.inlineLink);const Projects=()=>{const data=(0,gatsby_browser_entry.useStaticQuery)("3391063840");const{0:showMore,1:setShowMore}=(0,index_js_.useState)(false);const revealTitle=(0,index_js_.useRef)(null);const revealArchiveLink=(0,index_js_.useRef)(null);const revealProjects=(0,index_js_.useRef)([]);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();(0,index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default.reveal */.Z.reveal(revealTitle.current,(0,config.srConfig)());sr/* default.reveal */.Z.reveal(revealArchiveLink.current,(0,config.srConfig)());revealProjects.current.forEach((ref,i)=>sr/* default.reveal */.Z.reveal(ref,(0,config.srConfig)(i*100)));},[]);const GRID_LIMIT=6;const projects=data.projects.edges.filter(({node})=>node);const firstSix=projects.slice(0,GRID_LIMIT);const projectsToShow=showMore?projects:firstSix;const projectInner=node=>{const{frontmatter,html}=node;const{github,external,title,tech}=frontmatter;return/*#__PURE__*/index_js_default().createElement("div",{className:"project-inner"},/*#__PURE__*/index_js_default().createElement("header",null,/*#__PURE__*/index_js_default().createElement("div",{className:"project-top"},/*#__PURE__*/index_js_default().createElement("div",{className:"folder"},/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:"Folder"})),/*#__PURE__*/index_js_default().createElement("div",{className:"project-links"},github&&/*#__PURE__*/index_js_default().createElement("a",{href:github,"aria-label":"GitHub Link",target:"_blank",rel:"noreferrer"},/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:"GitHub"})),external&&/*#__PURE__*/index_js_default().createElement("a",{href:external,"aria-label":"External Link",className:"external",target:"_blank",rel:"noreferrer"},/*#__PURE__*/index_js_default().createElement(icons/* Icon */.JO,{name:"External"})))),/*#__PURE__*/index_js_default().createElement("h3",{className:"project-title"},/*#__PURE__*/index_js_default().createElement("a",{href:external,target:"_blank",rel:"noreferrer"},title)),/*#__PURE__*/index_js_default().createElement("div",{className:"project-description",dangerouslySetInnerHTML:{__html:html}})),/*#__PURE__*/index_js_default().createElement("footer",null,tech&&/*#__PURE__*/index_js_default().createElement("ul",{className:"project-tech-list"},tech.map((tech,i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},tech)))));};return/*#__PURE__*/index_js_default().createElement(StyledProjectsSection,null,/*#__PURE__*/index_js_default().createElement("h2",{ref:revealTitle},"Other Noteworthy Projects"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"inline-link archive-link",to:"/archive",ref:revealArchiveLink},"view the archive"),/*#__PURE__*/index_js_default().createElement("ul",{className:"projects-grid"},prefersReducedMotion?/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,projectsToShow&&projectsToShow.map(({node},i)=>/*#__PURE__*/index_js_default().createElement(projects_StyledProject,{key:i},projectInner(node)))):/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{component:null},projectsToShow&&projectsToShow.map(({node},i)=>/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{key:i,classNames:"fadeup",timeout:i>=GRID_LIMIT?(i-GRID_LIMIT)*300:300,exit:false},/*#__PURE__*/index_js_default().createElement(projects_StyledProject,{key:i,ref:el=>revealProjects.current[i]=el,style:{transitionDelay:`${i>=GRID_LIMIT?(i-GRID_LIMIT)*100:0}ms`}},projectInner(node)))))),/*#__PURE__*/index_js_default().createElement("button",{className:"more-button",onClick:()=>setShowMore(!showMore)},"Show ",showMore?'Less':'More'));};/* harmony default export */ const projects = (Projects);
;// CONCATENATED MODULE: ./src/components/sections/contact.js
const StyledContactSection=styled_components_esm["default"].section.withConfig({displayName:"contact__StyledContactSection",componentId:"sc-1m8df4t-0"})(["max-width:600px;margin:0 auto 100px;text-align:center;@media (max-width:768px){margin:0 auto 50px;}.overline{display:block;margin-bottom:20px;color:var(--green);font-family:var(--font-mono);font-size:var(--fz-md);font-weight:400;&:before{bottom:0;font-size:var(--fz-sm);}&:after{display:none;}}.title{font-size:clamp(40px,5vw,60px);}.email-link{",";margin-top:50px;}"],({theme})=>theme.mixins.bigButton);const Contact=()=>{const revealContainer=(0,index_js_.useRef)(null);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.Tb)();(0,index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default.reveal */.Z.reveal(revealContainer.current,(0,config.srConfig)());},[]);return/*#__PURE__*/index_js_default().createElement(StyledContactSection,{id:"contact",ref:revealContainer},/*#__PURE__*/index_js_default().createElement("h2",{className:"numbered-heading overline"},"What\u2019s Next?"),/*#__PURE__*/index_js_default().createElement("h2",{className:"title"},"Get In Touch"),/*#__PURE__*/index_js_default().createElement("p",null,"I\u2019m Actively looking for Full Stack Engineering/Data Engineering opportunities which help me build things. my inbox is always open."),/*#__PURE__*/index_js_default().createElement("a",{className:"email-link",href:`mailto:${config.email}`},"Say Hello"));};/* harmony default export */ const contact = (Contact);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "t$": () => (/* reexport */ hooks_useOnClickOutside),
  "Tb": () => (/* reexport */ hooks_usePrefersReducedMotion),
  "C7": () => (/* reexport */ hooks_useScrollDirection)
});
...
const useOnClickOutside=(ref,handler)=>{(0,index_js_.useEffect)(()=>{const listener=event=>{// Do nothing if clicking ref's element or descendent elements
...
[ref,handler]);};/* harmony default export */ const hooks_useOnClickOutside = (useOnClickOutside);
...
// occur.
isRenderingOnServer?true:!window.matchMedia(QUERY).matches;function usePrefersReducedMotion(){const{0:prefersReducedMotion,1:setPrefersReducedMotion}=(0,index_js_.useState)(getInitialState);(0,index_js_.useEffect)(()=>{const mediaQueryList=window.matchMedia(QUERY);const listener=event=>{setPrefersReducedMotion(!event.matches);};mediaQueryList.addListener(listener);return()=>{mediaQueryList.removeListener(listener);};},[]);return prefersReducedMotion;}/* harmony default export */ const hooks_usePrefersReducedMotion = (usePrefersReducedMotion);
;// CONCATENATED MODULE: ./src/hooks/useScrollDirection.js
const SCROLL_UP='up';const SCROLL_DOWN='down';const useScrollDirection=({initialDirection,thresholdPixels,off}={})=>{const{0:scrollDir,1:setScrollDir}=(0,index_js_.useState)(initialDirection);(0,index_js_.useEffect)(()=>{const threshold=thresholdPixels||0;let lastScrollY=window.pageYOffset;let ticking=false;const updateScrollDir=()=>{const scrollY=window.pageYOffset;if(Math.abs(scrollY-lastScrollY)<threshold){// We haven't exceeded the threshold
ticking=false;return;}setScrollDir(scrollY>lastScrollY?SCROLL_DOWN:SCROLL_UP);lastScrollY=scrollY>0?scrollY:0;ticking=false;};const onScroll=()=>{if(!ticking){window.requestAnimationFrame(updateScrollDir);ticking=true;}};/**
     * Bind the scroll handler if `off` is set to false.
     * If `off` is set to true reset the scroll direction.
     */!off?window.addEventListener('scroll',onScroll):setScrollDir(initialDirection);return()=>window.removeEventListener('scroll',onScroll);},[initialDirection,thresholdPixels,off]);return scrollDir;};/* harmony default export */ const hooks_useScrollDirection = (useScrollDirection);
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9550);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(537);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utils_sr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6179);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3558);
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9086);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3082);
const StyledTableContainer=styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].div.withConfig({displayName:"archive__StyledTableContainer",componentId:"sc-2cxdc9-0"})(["margin:100px -20px;@media (max-width:768px){margin:50px -10px;}table{width:100%;border-collapse:collapse;.hide-on-mobile{@media (max-width:768px){display:none;}}tbody tr{&:hover,&:focus{background-color:var(--light-navy);}}th,td{padding:10px;text-align:left;&:first-child{padding-left:20px;@media (max-width:768px){padding-left:10px;}}&:last-child{padding-right:20px;@media (max-width:768px){padding-right:10px;}}svg{width:20px;height:20px;}}tr{cursor:default;td:first-child{border-top-left-radius:var(--border-radius);border-bottom-left-radius:var(--border-radius);}td:last-child{border-top-right-radius:var(--border-radius);border-bottom-right-radius:var(--border-radius);}}td{&.year{padding-right:20px;@media (max-width:768px){padding-right:10px;font-size:var(--fz-sm);}}&.title{padding-top:15px;padding-right:20px;color:var(--lightest-slate);font-size:var(--fz-xl);font-weight:600;line-height:1.25;}&.company{font-size:var(--fz-lg);white-space:nowrap;}&.tech{font-size:var(--fz-xxs);font-family:var(--font-mono);line-height:1.5;.separator{margin:0 5px;}span{display:inline-block;}}&.links{min-width:100px;div{display:flex;align-items:center;a{",";flex-shrink:0;}a + a{margin-left:10px;}}}}}"],({theme})=>theme.mixins.flexCenter);const ArchivePage=({location,data})=>{const projects=data.allMarkdownRemark.edges;const revealTitle=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);const revealTable=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);const revealProjects=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)([]);const prefersReducedMotion=(0,_hooks__WEBPACK_IMPORTED_MODULE_6__/* .usePrefersReducedMotion */ .Tb)();(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(prefersReducedMotion){return;}_utils_sr__WEBPACK_IMPORTED_MODULE_3__/* ["default"].reveal */ .Z.reveal(revealTitle.current,(0,_config__WEBPACK_IMPORTED_MODULE_2__.srConfig)());_utils_sr__WEBPACK_IMPORTED_MODULE_3__/* ["default"].reveal */ .Z.reveal(revealTable.current,(0,_config__WEBPACK_IMPORTED_MODULE_2__.srConfig)(200,0));revealProjects.current.forEach((ref,i)=>_utils_sr__WEBPACK_IMPORTED_MODULE_3__/* ["default"].reveal */ .Z.reveal(ref,(0,_config__WEBPACK_IMPORTED_MODULE_2__.srConfig)(i*10)));},[]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_4__/* .Layout */ .Ar,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_1__.Helmet,{title:"Archive"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",{ref:revealTitle},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"big-heading"},"Archive"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"subtitle"},"A big list of things I\u2019ve worked on")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledTableContainer,{ref:revealTable},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("table",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("thead",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",null,"Year"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",null,"Title"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",{className:"hide-on-mobile"},"Made at"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",{className:"hide-on-mobile"},"Built with"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",null,"Link"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tbody",null,projects.length>0&&projects.map(({node},i)=>{if(node.title!='Moms Demand Action Mobile App'){const{date,github,external,ios,android,title,tech,company}=node.frontmatter;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr",{key:i,ref:el=>revealProjects.current[i]=el},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"overline year"},`${new Date(date).getFullYear()}`),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"title"},title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"company hide-on-mobile"},company?/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,company):/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,"\u2014")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"tech hide-on-mobile"},tech.length>0&&tech.map((item,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{key:i},item,'',i!==tech.length-1&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{className:"separator"},"\xB7")))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"links"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,external&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:external,"aria-label":"External Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_5__/* .Icon */ .JO,{name:"External"})),github&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:github,"aria-label":"GitHub Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_5__/* .Icon */ .JO,{name:"GitHub"})),ios&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:ios,"aria-label":"Apple App Store Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_5__/* .Icon */ .JO,{name:"AppStore"})),android&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:android,"aria-label":"Google Play Store Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_5__/* .Icon */ .JO,{name:"PlayStore"})))));}}))))));};ArchivePage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_8___default().object.isRequired),data:(prop_types__WEBPACK_IMPORTED_MODULE_8___default().object.isRequired)};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ArchivePage);const pageQuery="301981035";
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9550);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3558);
const StyledMainContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].main.withConfig({displayName:"pages__StyledMainContainer",componentId:"sc-1tzx2o8-0"})(["counter-reset:section;"]);const IndexPage=({location})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ .Ar,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer,{className:"fillHeight"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Hero */ .VM,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .About */ .CL,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Jobs */ .pe,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Featured */ .g4,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Projects */ .pj,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Contact */ .r8,null)));IndexPage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_3___default().object.isRequired)};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexPage);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2031);
/* harmony import */ var lodash_kebabCase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1804);
...
/* harmony import */ var react_helmet__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4593);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9550);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3558);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Cs": () => (/* binding */ loaderDelay),
/* harmony export */   "fb": () => (/* binding */ navDelay),
/* harmony export */   "nx": () => (/* binding */ KEY_CODES)
/* harmony export */ });
/* unused harmony export hex2rgba */
const hex2rgba=(hex,alpha=1)=>{const[r,g,b]=hex.match(/\w\w/g).map(x=>parseInt(x,16));return`rgba(${r},${g},${b},${alpha})`;};const navDelay=1000;const loaderDelay=2000;const KEY_CODES={ARROW_LEFT:'ArrowLeft',ARROW_LEFT_IE11:'Left',ARROW_RIGHT:'ArrowRight',ARROW_RIGHT_IE11:'Right',ARROW_UP:'ArrowUp',ARROW_UP_IE11:'Up',ARROW_DOWN:'ArrowDown',ARROW_DOWN_IE11:'Down',ESCAPE:'Escape',ESCAPE_IE11:'Esc',TAB:'Tab',SPACE:' ',SPACE_IE11:'Spacebar',ENTER:'Enter'};
...
/* harmony export */ });
/* harmony import */ var scrollreveal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(123);
...
const isSSR=typeof window==='undefined';const sr=isSSR?null:scrollreveal__WEBPACK_IMPORTED_MODULE_0___default()();/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (sr);
...
*/
var aa=__webpack_require__(6806),m=__webpack_require__(4852),r=__webpack_require__(3840);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
var _gtag = _interopRequireDefault(__webpack_require__(6161));
var _format = _interopRequireDefault(__webpack_require__(9559));
...
var _ga = _interopRequireWildcard(__webpack_require__(1638));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6806);
...
var React = __webpack_require__(6806);
...
var CSSTransition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/index_js_default().createElement(esm_Transition, (0,esm_extends/* default */.Z)({}, props, {
...
"use strict";
module.exports = require("/Users/vamshisaggurthi/Downloads/Devlopment/Personal website/personal_website/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = JSON.parse('{"layout":"constrained","backgroundColor":"#382828","images":{"fallback":{"src":"/static/8d3b83f99923fef35f30bbfbe727198c/25f3c/me.jpg","srcSet":"/static/8d3b83f99923fef35f30bbfbe727198c/2dd75/me.jpg 125w,\\n/static/8d3b83f99923fef35f30bbfbe727198c/754ad/me.jpg 250w,\\n/static/8d3b83f99923fef35f30bbfbe727198c/25f3c/me.jpg 500w","sizes":"(min-width: 500px) 500px, 100vw"},"sources":[{"srcSet":"/static/8d3b83f99923fef35f30bbfbe727198c/aebc8/me.avif 125w,\\n/static/8d3b83f99923fef35f30bbfbe727198c/6b255/me.avif 250w,\\n/static/8d3b83f99923fef35f30bbfbe727198c/f9526/me.avif 500w","type":"image/avif","sizes":"(min-width: 500px) 500px, 100vw"},{"srcSet":"/static/8d3b83f99923fef35f30bbfbe727198c/4155f/me.webp 125w,\\n/static/8d3b83f99923fef35f30bbfbe727198c/02deb/me.webp 250w,\\n/static/8d3b83f99923fef35f30bbfbe727198c/1ee78/me.webp 500w","type":"image/webp","sizes":"(min-width: 500px) 500px, 100vw"}]},"width":500,"height":500}');
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-5b149e72e8fffedddf36.js"],"app":["/app-9100b30cc98dbbb2ebb2.js"],"component---cache-caches-gatsby-plugin-offline-app-shell-js":["/component---cache-caches-gatsby-plugin-offline-app-shell-js-27c66d5dcd0cba7d37a1.js"],"component---src-pages-404-js":["/component---src-pages-404-js-99eddb95b3b16cdd3a79.js"],"component---src-pages-archive-js":["/component---src-pages-archive-js-323fd68e2bb1930318e4.js"],"component---src-pages-index-js":["/component---src-pages-index-js-878d54754c7cad0c4749.js"],"component---src-pages-pensieve-index-js":["/component---src-pages-pensieve-index-js-faca877960f44f3cbd58.js"],"component---src-pages-pensieve-tags-js":["/component---src-pages-pensieve-tags-js-b5756c4311d7a659871c.js"],"component---src-templates-post-js":["/component---src-templates-post-js-3923ff542fe8c41d7ffa.js"],"component---src-templates-tag-js":["/component---src-templates-tag-js-012a95c53bc45715838a.js"]}');
...
/* harmony export */ });
const React=__webpack_require__(6806);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,pipeToNodeWritable}=__webpack_require__(895);const{ServerLocation,Router,isRedirect}=__webpack_require__(3631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(2031);const fs=__webpack_require__(8965);const{WritableAsPromise}=__webpack_require__(1945);const{RouteAnnouncerProps}=__webpack_require__(5394);const{apiRunner,apiRunnerAsync}=__webpack_require__(9874);const syncRequires=__webpack_require__(885);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(8451);const chunkMapping=__webpack_require__(9804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
